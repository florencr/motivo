...
const res = await c.query(
  `UPDATE "Listing" l
   SET "sellerType" = u."sellerType"
   FROM "User" u
   WHERE l."sellerId" = u.id AND u."sellerType" IS NOT NULL AND l."sellerType" <> u."sellerType"
   RETURNING l.id, u.email, l."sellerType"`,
);
console.log(`Synced ${res.rowCount} listings:`);
